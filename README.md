...
[`docs/demo.cast`](docs/demo.cast) — asciinema recording of `phantom_companion.cli daily-report` running all 5 insight modules (mostly baseline today; signal accrues with daily use).
